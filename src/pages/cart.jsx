        ...
        <div className="w-full h-[calc(100vh-100px)] bg-primary pt-[25px] flex flex-col items-center ">
            <div className="w-[600px] flex flex-col gap-4">
                ...
                <div className="w-full h-[120px] bg-white flex justify-end items-center relative">
                    <Link to="/checkout" className="absolute left-0 bg-accent text-white font-semibold  hover:bg-accent/90 active:scale-95 transition-all duration-300 px-[20px] py-[10px] ml-[20px]" state={cart} >Proceed to Checkout</Link>
